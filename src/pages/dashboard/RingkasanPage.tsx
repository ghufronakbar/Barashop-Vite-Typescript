...
import { Ringkasan } from "@/model/Ringkasan";
...
const getFinancialChartData = (data?: Ringkasan) => {
  if (!data) {
...
const getProductDoughnutChartData = (
  data?: Ringkasan
...
const RingkasanPage = () => {
  ...
  useEffect(() => {
    ...
    const financeChart = new ChartJS(financeCanvas as ChartItem, {
      type: "line",
    ...
    const productChart = new ChartJS(productCanvas as ChartItem, {
      type: "doughnut",
            ...
            <div className="flex flex-col gap-2">
              {getProductDoughnutChartData(data)?.labels?.map((_, index) => (
                <div key={index} className="flex flex-row gap-2 items-center">
                  ...
                  <p className="text-sm">
                    {
                      getProductDoughnutChartData(data)?.labels?.[
                        index
                      ] as string
                    }
                  </p>
